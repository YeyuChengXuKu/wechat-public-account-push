...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxb1968953bbedfeab',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '1b738e61fa701e441fff36f15689106e',
  ...
  USERS: [
    {
      ...
      id: 'omJ5U6N4StjL6c0piEojGe81W5c0',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'q8sLvfxH_R_TN6iJtsDef9VgG9X--i1yLKJBUNk_s_I',
      // 所在省份
      province: '重庆',
      // 所在城市
      city: '重庆市',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '老婆', year: '2002', date: '04-17',
        },
        {
          type: '节日', name: '二周年纪念日', year: '2020', date: '06-16',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '老公', year: '2001', date: '01-14',
        },
        {
          type: '节日', name: '下一次见面', year: '2021', date: '01-01',
        }
      ],
